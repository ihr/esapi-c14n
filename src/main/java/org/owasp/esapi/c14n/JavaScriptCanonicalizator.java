 ...
 * @since June 1, 2007
 */
public class JavaScriptCanonicalizator implements Canonicalizator {

    private final JavaScriptDecoder javaScriptDecoder;

    public JavaScriptCanonicalizator(JavaScriptDecoder javaScriptDecoder) {
        this.javaScriptDecoder = javaScriptDecoder;
    }
    ...
    public String canonicalize(String input) {
        ...
        while (!clean) {
            clean = true;
                ...
                String old = working;
                working = javaScriptDecoder.decode(working);
