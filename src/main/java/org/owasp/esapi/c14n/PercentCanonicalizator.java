 ...
 * @since June 1, 2007
 */
public class PercentCanonicalizator implements Canonicalizator {

    private final PercentDecoder percentDecoder;

    public PercentCanonicalizator(PercentDecoder percentDecoder) {
    ...
    public String canonicalize(String input) {
        ...
        while (!clean) {
            clean = true;
                ...
                String old = working;
                working = percentDecoder.decode(working);
