 ...
 * <b>NOTE:</b><br>
 * <ul>
 *	<li>{@link java.util.Map.remove(Object)} is not supported.</li>
 *	<li>
...
public class HashTrie<T> implements Trie<T>
{
	...
	private static class Node<T>
	{
		 ...
		 * @param key that is being looked up at this level.
	 ...
	 * @return Entry with the longest matching key.
	 * @throws java.io.IOException if keyIn.read() or keyIn.unread() does.
	 */
